...
[![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ] [![Version: 2.1.0](https://img.shields.io/badge/Version-2.1.0-informational?style=flat-square) ] [![AppVersion: 8.0.3](https://img.shields.io/badge/AppVersion-8.0.3-informational?style=flat-square) ]

* <https://github.com/aquaveo/misc-helm-charts>
* <https://github.com/docker-library/redis>
* <https://github.com/redis/redis>
* <https://redis.io>

Credits to [pacalike helm charts](https://github.com/pascaliske/helm-charts)
...
```sh
helm repo add aquaveo oci://ghcr.io/aquaveo
```
...
```sh
helm install redis aquaveo/redis
```
...
| Name | Email | Url |
| ---- | ------ | --- |
| aquaveo | <gromero@aquaveo.com> | <https://aquaveo.com> |
## License

[BSD-2-Clause license](../LICENSE.md) – © 2025 [Aquaveo](https://aquaveo.com)
